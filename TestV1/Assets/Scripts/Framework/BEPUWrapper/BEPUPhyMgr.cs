...
public class BEPUPhyMgr : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        this.space.TimeStepSettings.TimeStepDuration = 1 / 120m; // 设置迭代时间间隔
        this.space.DeactivationManager.VelocityLowerLimit = 0.001m;
        this.space.DeactivationManager.LowVelocityTimeMinimum = 0.2m;
    }
